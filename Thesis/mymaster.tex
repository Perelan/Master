...
\chapter*{Abstract}
 ...
 Observations and experiments have shown that the application is capable of collect data over an extended period using the Flow sensor. More specifically, an 8-hours of recording use approximately 1240 mAh of battery, which is well sufficient based on the average battery capacity of a mobile device. Also, the application is able to reconnect with the sensor upon disconnect---with the results from the experiment, no more than 40\% of the data is lost. Finally, other developers are successfully able to create modules that integrate and extend the functionality of Nidra. 
