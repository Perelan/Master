...
\begin{itemize}
    \item[6.1] \verb|UI|: 
    \item[6.1.1] \verb|Views|: Are the screen with the content of the current screen. The view incorporates the color palette and some views have the navigation displayed. 
